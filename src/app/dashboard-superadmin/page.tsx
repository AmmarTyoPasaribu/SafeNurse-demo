      ...
      <main className="flex-1 px-6 py-6">
        ...
        >
          ...
          <div className="relative z-10">
            {/* Page Title */}
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-2">Manajemen User</h2>
              <p className="text-white/80">Kelola dan pantau daftar user dalam sistem</p>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
              ...
              <div className="bg-[#0E364A] px-6 py-4">
                <div className="grid grid-cols-5 gap-6">
                  ...
                  <div className="text-center">
                    <h3 className="text-white font-semibold text-lg">RUANGAN</h3>
                  </div>
                  <div className="text-center">
              ...
              <div className="divide-y divide-gray-200">
                {filteredUsers.map((user, index) => (
                  <div key={user.id} className={`grid grid-cols-5 gap-6 px-6 py-4 ${index % 2 === 0 ? 'bg-[#B9D9DD]' : 'bg-white'}`}>
                    <div className="text-center text-gray-800 font-medium">{user.nama}</div>
                    <div className="text-center text-gray-600">{user.email}</div>
                    <div className="text-center text-gray-600">{user.role}</div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[#B9D9DD] rounded-lg p-8 w-96 max-w-md mx-4 relative">
            ...
            <h2 className="text-xl font-semibold text-center mb-6 text-[#0E364A]">Create Account</h2>
            
            <div className="space-y-4">
              <div>
                <label className="block text-[#0E364A] font-medium mb-2">Nama :</label>
                <input 
                  type="text"
                  value={newUser.nama}
              ...
              <div>
                <label className="block text-[#0E364A] font-medium mb-2">Role :</label>
                <select 
                  value={newUser.role}
              ...
              <div>
                <label className="block text-[#0E364A] font-medium mb-2">Unit Kerja / Ruangan :</label>
                <select 
                  value={newUser.unitKerja}
                  onChange={(e) => setNewUser({...newUser, unitKerja: e.target.value})}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0B7A95] text-black bg-white"
                >
              ...
              <div>
                <label className="block text-[#0E364A] font-medium mb-2">Email :</label>
                <input 
                  type="email"
                  value={newUser.email}
              ...
              <div>
                <label className="block text-[#0E364A] font-medium mb-2">No. Telepon :</label>
                <input 
                  type="tel"
              ...
              <div>
                <label className="block text-[#0E364A] font-medium mb-2">Password :</label>
                <input 
                  type="password"
