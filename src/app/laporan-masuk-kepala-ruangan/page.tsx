          ...
          <div className="relative z-10">
            ...
            <div className="space-y-3 sm:space-y-4 animate-fade-in-delay-2">
              {reports.map((report, index) => (
                <div
                  key={report.id}
                  className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-3 sm:p-6 hover:bg-white/95 transition-colors cursor-pointer transform hover:scale-105"
