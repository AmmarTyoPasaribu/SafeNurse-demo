              ...
              <div className="max-w-4xl w-full space-y-6">
                ...
                <div className="flex flex-col lg:flex-row gap-4 md:gap-6">
                  ...
                  <div className="bg-white/95 rounded-2xl p-4 md:p-6 shadow-2xl flex flex-col items-center">
                    <div className="w-20 md:w-24 h-20 md:h-24 bg-[#4A9B8E] rounded-full flex items-center justify-center mb-3 md:mb-4">
                      <i className="fas fa-user-shield text-2xl md:text-3xl text-white"></i>
                    </div>
                ...
                <div className="bg-white/95 rounded-2xl p-4 md:p-6 shadow-2xl">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <button
                      ...
                      className="bg-[#6B8CAE] text-white px-3 md:px-6 py-2 rounded-lg hover:bg-[#5A7A9A] transition-colors font-medium text-xs md:text-base w-full sm:w-auto"
                    >
                      Change Account
                    </button>
                  </div>
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="bg-[#2C3E50] text-white px-4 md:px-8 py-2 md:py-3 rounded-lg hover:bg-[#34495E] transition-colors font-medium text-sm md:text-base w-full sm:w-auto max-w-xs"
                  >
                    Logout
                  </button>
                </div>
