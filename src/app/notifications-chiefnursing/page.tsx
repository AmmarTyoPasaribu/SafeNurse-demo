...
export default function NotificationsChiefNursingPage() {
  ...
  const [notifications] = useState([
    {
      id: 1,
      title: "Laporan infeksi nosokomial dari ruang ICU telah diterima dan memerlukan tindak lanjut segera.",
      time: "2 jam yang lalu",
      isRead: false
    },
    {
      id: 2,
      title: "Laporan kontrol infeksi dari ruang bedah telah diterima dan memerlukan review Anda.",
      time: "4 jam yang lalu",
      isRead: false
    },
    {
      id: 3,
      title: "Laporan surveillance infeksi dari ruang anak telah diterima dan memerlukan analisis.",
      time: "6 jam yang lalu",
      isRead: false
    },
    {
      id: 4,
      title: "Laporan outbreak potensial dari ruang internal telah diterima dan memerlukan investigasi.",
      time: "1 hari yang lalu",
      isRead: false
    },
    {
      id: 5,
      title: "Laporan kepatuhan hand hygiene dari seluruh ruangan telah diterima untuk evaluasi bulanan.",
      ...
      <header className="bg-[#B9D9DD] rounded-xl px-6 py-3 mx-6 mt-6">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {/* Laporan Masuk */}
            <button className="flex flex-col items-center text-white hover:text-[#0B7A95] transition-colors" onClick={() => window.location.href = '/laporan-masuk-chiefnursing'}>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-white/20">
            <div className="flex flex-col space-y-3">
              ...
              <button
                className="flex items-center text-white hover:text-[#0B7A95] transition-colors p-2 rounded"
                onClick={() => window.location.href = '/laporan-masuk-chiefnursing'}
              >
