...
export default function NotificationsKepalaRuanganPage() {
  ...
  const [notifications] = useState([
    {
      id: 1,
      title: "Laporan dari perawat A/N Siti Nurhaliza mengenai pasien Budi Santoso telah diterima dan memerlukan review Anda.",
      time: "2 jam yang lalu",
      isRead: false
    },
    {
      id: 2,
      title: "Laporan dari perawat A/N Ahmad Fauzi mengenai pasien Maria Sari telah diterima dan memerlukan review Anda.",
      time: "4 jam yang lalu",
      isRead: false
    },
    {
      id: 3,
      title: "Laporan dari perawat A/N Dewi Lestari mengenai pasien Joko Widodo telah diterima dan memerlukan review Anda.",
      time: "6 jam yang lalu",
      isRead: false
    },
    {
      id: 4,
      title: "Laporan dari perawat A/N Rina Sari mengenai pasien Sari Indah telah diterima dan memerlukan review Anda.",
      time: "1 hari yang lalu",
      isRead: false
    },
    {
      id: 5,
      title: "Laporan dari perawat A/N Budi Hartono mengenai pasien Ani Susanti telah diterima dan memerlukan review Anda.",
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-white/20">
            <div className="flex flex-col space-y-3">
              ...
              <button
                className="flex items-center text-white hover:text-[#0B7A95] transition-colors p-2 rounded"
                onClick={() => window.location.href = '/laporan-masuk-kepala-ruangan'}
              >
