...
export default function NotificationsVerifikatorPage() {
  ...
  const [notifications] = useState([
    {
      id: 1,
      title: "Laporan insiden baru dari perawat A/N Siti Nurhaliza telah masuk dan memerlukan verifikasi Anda.",
      time: "1 jam yang lalu",
      isRead: false
    },
    {
      id: 2,
      title: "Laporan insiden dari unit IGD telah direvisi dan siap untuk verifikasi ulang.",
      time: "3 jam yang lalu",
      isRead: false
    },
    {
      id: 3,
      title: "Reminder: Terdapat 5 laporan yang belum diverifikasi dalam 24 jam terakhir.",
      time: "5 jam yang lalu",
      isRead: false
    },
    {
      id: 4,
      title: "Laporan insiden kategori KTD dari unit ICU memerlukan perhatian segera.",
      ...
      <header className="bg-[#B9D9DD] rounded-xl px-6 py-3 mx-6 mt-6">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {/* Riwayat Laporan */}
            <button className="flex flex-col items-center text-white hover:text-[#0B7A95] transition-colors" onClick={() => window.location.href = '/riwayat-laporan-verifikator'}>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-white/20">
            <div className="flex flex-col space-y-3">
              ...
              {/* Riwayat Laporan */}
              <button className="flex items-center text-white hover:text-[#0B7A95] transition-colors p-2 rounded" onClick={() => window.location.href = '/riwayat-laporan-verifikator'}>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">Daftar notifikasi terbaru untuk verifikator</p>
            </div>
